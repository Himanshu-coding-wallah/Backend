...
## Types
1. Document middleware -> Runs on individual document(data)  
This refers to document  
Used with save, init, validate, updateOne, deleteOne

2. Query middleware-> Runs on query object  
This refers to query object  
Used with find, findOne

3. Model middlewares -> Runs on model function  
This refers to model
Used with inserMany

4. Aggregate middlewares -> Runs on aggregate pipeline  
